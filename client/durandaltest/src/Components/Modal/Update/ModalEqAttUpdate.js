...
function ModalEqAttUpdate(props) {
    const successAlert = () => {
        toast.success("Atributo actualizado exitosamente en la base de datos.", {
            position: "top-right",
            autoClose: 2000,
      ...
      const errorAlert = () => {
        toast.error("Error al actualizar atributo. Vuelve a intentarlo.", {
            position: "top-right",
            autoClose: 2000,
            hideProgressBar: false,
            closeOnClick: true,
    ...
    return (
        ...
        >
            ...
            <Modal.Footer>
                <button className='update-modal-button' onClick={() => {hide(); updateAtt()}}>Guardar cambios</button>
            </Modal.Footer>
        </Modal>
    );
};

export default ModalEqAttUpdate;